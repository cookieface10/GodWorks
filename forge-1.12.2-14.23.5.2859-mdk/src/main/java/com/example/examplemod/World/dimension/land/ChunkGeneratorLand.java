...
public class ChunkGeneratorLand implements IChunkGenerator
{
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = Blocks.LAPIS_BLOCK.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK2 = ModBlocks.POO_BLOCK.getDefaultState();
    ...
    */
    ...
    public ChunkGeneratorLand(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.LAND_DIMENSION);
        }
